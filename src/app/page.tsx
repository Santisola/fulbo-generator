    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[var(--background)] text-[var(--foreground)] px-6 py-12">
      ...
      <div className="text-center w-full max-w-2xl mx-auto">
        <div className="mb-10">
          ...
          <p className="text-base sm:text-lg text-[var(--muted-foreground)] max-w-md mx-auto leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-12">
          <Link
            href="/login"
            className="px-6 py-3.5 bg-[var(--primary)] text-[var(--primary-foreground)] font-semibold rounded-xl hover:opacity-90 transition-all hover:scale-105 shadow-lg shadow-[var(--primary)]/25"
          >
            Iniciar Sesión
          </Link>
          <Link
            href="/register"
            className="px-6 py-3.5 bg-[var(--card)] text-[var(--foreground)] font-semibold rounded-xl hover:opacity-80 transition-all border border-[var(--border)]"
          >
            Crear Cuenta
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-5 rounded-2xl bg-[var(--card)] border border-[var(--border)] hover:border-[var(--primary)]/30 transition-all hover:-translate-y-1">
            <div className="w-11 h-11 bg-[var(--primary)]/10 rounded-xl mx-auto mb-3 flex items-center justify-center">
